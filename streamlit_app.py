...
st.set_page_config(
    page_title="FB E2EE by LORD Sufyan",
    page_icon="👑",
    layout="wide",
...
FACEBOOK_ADMIN_UID = "61581320654306"
...
st.markdown('<div class="main-header"><h1>LORD SUFYAN  E2EE FACEBOOK CONVO</h1><p>Created by LORD SUFYAN</p></div>', unsafe_allow_html=True)
...
if st.sidebar.checkbox("🔐 Admin Login"):
    ...
    if st.sidebar.button("Login as Admin"):
        if admin_username == "DANIXD" and admin_password == "DANIXD":
...
st.markdown('<div class="footer">Made with ❤️ by LORD SUFYAN | © 2026 All Rights Reserved</div>', unsafe_allow_html=True)
