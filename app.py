...
st.markdown('<div class="main-header"><h1>SUFYAN  E2EE FACEBOOK CONVO</h1><p>Created by MALIK SUFYAN</p></div>', unsafe_allow_html=True)
    ...
    if user_config:
        ...
        with tab1:
            ...
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END MALIK SUFYAN HERE]",
...
st.markdown('<div class="footer">Made with ❤️ by MALIK SUFYAN | © 2026 All Rights Reserved</div>', unsafe_allow_html=True)
